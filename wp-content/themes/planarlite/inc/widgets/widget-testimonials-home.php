...
class Planar_Testimonial_HomeWidgets extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			'Planar ' . __( 'Homepage Testimonials', 'planar-lite' ),
			array(
				'classname' => 'testimonial_home_widgets', 
				'description' => __( 'Testimonials section on the Home Page.', 'planar-lite' ),
			)
		);
 	}

 	function form( $instance ) {
		$planar_defaults[ 'title_section' ] = __( 'Testimonials', 'planar-lite' );
 		$planar_defaults[ 'text_main' ] = __( 'This widget shows Testimonials section on the Home Page.', 'planar-lite' );
		...
		<p><?php _e( 'This widget shows Testimonials section on the Home Page.', 'planar-lite' ); ?></p>
