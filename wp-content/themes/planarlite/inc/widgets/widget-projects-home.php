...
class Planar_Project_HomeWidgets extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			'Planar ' . __( 'Homepage Projects', 'planar-lite' ),
			array(
				'classname' => 'project_home_widgets', 
				'description' => __( 'Projects section on the Home Page.', 'planar-lite' ),
			)
		);
 	}

 	function form( $instance ) {
		$planar_defaults[ 'title_section' ] = __( 'Portfolio', 'planar-lite' );
 		$planar_defaults[ 'text_main' ] = __( 'Widget display projects (Projects plugin) section on the Home Page.', 'planar-lite' );
		...
		<p><?php _e( 'The widget for displaying projects (Projects plugin) section on the Home Page', 'planar-lite' ); ?></p>
		...
		<p>
		<label for="<?php echo $this->get_field_id('limit_num'); ?>"><?php _e( 'Number of projects to show:', 'planar-lite' ); ?></label>
