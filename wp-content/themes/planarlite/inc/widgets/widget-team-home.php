...
class Planar_Team_HomeWidgets extends WP_Widget {
	function __construct() {
		parent::__construct(
			'team_home_widgets',
			'Planar ' . __( 'Homepage Team', 'planar-lite' ),
			array(
				'classname' => 'team_home_widgets', 
				'description' => __( 'Team section on the Home Page.', 'planar-lite' ),
			)
		);
 	}

 	function form( $instance ) {
		$planar_defaults[ 'title_section' ] = __( 'Our Team', 'planar-lite' );
 		$planar_defaults[ 'text_main' ] = __( 'This widget shows Team section on the Home Page.', 'planar-lite' );
